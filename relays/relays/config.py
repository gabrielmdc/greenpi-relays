...
class Config:
    #def __init__(self, fileName = os.environ['HOME'] + "/.greenPi/relays/config.json"):
        ...
        if "cycles" in config:
            ...
            for cycle in self.cycles:
                ...
                for subCycle in cycle.subCycles:
                    ...
                    elif type(subCycle) is dict and "programName" in subCycle:
                        newSubCycle = self.getCycle(cycleName)
